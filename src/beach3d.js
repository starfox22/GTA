       ...
       *   - people are drawn by the shared character rig (crowd3d.js), which
      ...
      /**
       * PEOPLE
       * Beachgoers are drawn with everyone else by the character rig
       * (crowd3d.js BEACHGOERS): swimwear, towel poses, swimming strokes and
       * the volleyball touches, from each one's `pose`, `z` and look fields.
       */
