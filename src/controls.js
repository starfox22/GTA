    ...
    const CONTROL_ACTIONS = [
      ...
      { id: 'weapon1', label: 'Pistol', note: 'Weapon slot 1', group: 'weapons', keys: ['Digit1'], ctx: ['foot', 'drive', 'air'] },
      { id: 'weapon2', label: 'Machine pistol', note: 'Weapon slot 2', group: 'weapons', keys: ['Digit2'], ctx: ['foot', 'drive', 'air'] },
      { id: 'weapon3', label: 'Shotgun', note: 'Weapon slot 3', group: 'weapons', keys: ['Digit3'], ctx: ['foot', 'drive', 'air'] },
      { id: 'weapon4', label: 'Bazooka', note: 'Weapon slot 4', group: 'weapons', keys: ['Digit4'], ctx: ['foot', 'drive', 'air'] },
      { id: 'weapon5', label: 'Assault rifle', note: 'Weapon slot 5', group: 'weapons', keys: ['Digit5'], ctx: ['foot', 'drive', 'air'] },
      { id: 'weapon6', label: 'Precision rifle', note: 'Weapon slot 6', group: 'weapons', keys: ['Digit6'], ctx: ['foot', 'drive', 'air'] },
      ...
      { id: 'zoomIn', label: 'Zoom in', note: 'Street camera zoom', group: 'interface', keys: ['Equal', 'NumpadAdd'], ctx: EVERYWHERE },
      { id: 'zoomOut', label: 'Zoom out', note: 'Street camera zoom', group: 'interface', keys: ['Minus', 'NumpadSubtract'], ctx: EVERYWHERE },
