...
Everything older than the section in docs/CHANGELOG.md, newest first. Not needed for
day-to-day work: grep it for the history of a feature.

The first block holds the full notes of the changes made after 30.0.0 and before the
...
## After 30.0.0 (unreleased) — MONARCH MOTORS and the Prestige Collection
...
## After 30.0.0 (unreleased) — the Palm Sound drawbridge: 44 m leaves and the opening as a spectacle
...
## After 30.0.0 (unreleased) — streets and parks drawn at screen resolution, and a closer camera
...
## After 30.0.0 (unreleased) — GOALLINE, the sports betting office by the stadium
...
## After 30.0.0 (unreleased) — the tree library
...
## After 30.0.0 (unreleased) — the radio on the title screen
...
## After 30.0.0 (unreleased) — the car and motorbike redesign, and the flagships
...
## After 30.0.0 (unreleased) — Monarch Isle: a rich island district north of the mountains
...
## After 30.0.0 (unreleased) — one character rig for everyone: the player, police, NPCs
...
## After 30.0.0 (unreleased) — the respray garages: real-scale workshops, prices and a drive-in show
...
## After 30.0.0 (unreleased) — tighter steering, rain for every driver, riders thrown, helicopters that break up, the drawbridge launch
...
## After 30.0.0 (unreleased) — wet streets, the ULTRA band, phantom shadows
...
## After 30.0.0 (unreleased) — true scale: vehicles, people, buildings and street furniture
...
## After 30.0.0 (unreleased) — the Marea pool, club conversations and beach volleyball
...
## After 30.0.0 (unreleased) — speed box on foot, km/h / mph, South Coast Cycle bike share
...
## After 30.0.0 (unreleased) — speech bubbles seen from above, the Falcon's riders scream and talk
...
## After 30.0.0 (unreleased) — ramming roadblocks, crash physics, breakable trees and furniture
...
## After 30.0.0 (unreleased) — no snipers, an unarmed police helicopter, the Apache
...
## After 30.0.0 (unreleased) — God mode settings
...
## After 30.0.0 (unreleased) — run by default, the radio volume slider and the audio mixer
...
## After 30.0.0 (unreleased) — realistic runways
...
## After 30.0.0 (unreleased) — stadium sound and screens
...
## After 30.0.0 (unreleased) — skip the ride
...
## After 30.0.0 (unreleased) — real speeds
...
## After 30.0.0 (unreleased) — prompts out of the way
